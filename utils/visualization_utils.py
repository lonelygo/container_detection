...
#    output_path,
  ...
  # # Crop bounding box to splt images,move out of this file for OCR.
  ...
  #   image_corp = image[new_ymin:new_ymax,new_xmin:new_xmax] 
         
  #   image_corp = Image.fromarray(np.uint8(image_corp))
    
  #   # Save corp image to outo_path ,and join output lable in name.
  #   if img_name.find('container_number') >= 0:
  #     t += 1
  #     image_corp.save(os.path.join(output_path) + '/' +img_name +'_' + (str(t)+'_') + os.path.basename(image_path))
